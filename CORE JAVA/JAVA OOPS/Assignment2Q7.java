...
public class Assignment2Q7 {
    ...
    private void placeOrderOperation(int choice) {
        ...
        case 1:
            ...
            System.out.println("Candies order placed succesfully and total cost is " + total);
            break;
        case 2:
            Cookie cookie = new Cookie();
            ...
            System.out.println("Cookies order placed succesfully and total  cost is " + total);
            break;
        case 3:
            IceCream iceCream = new IceCream();
            System.out.println("Enter the amount of Ice Cream to be added ");
            ...
            System.out.println("Ice Creams order placed succesfully and total cost is : " + total);
        default:
